...
from app.prompts.form_1098_prompts import FORM_1098_EXTRACTION_PROMPT
...
async def extract_1098_details(
    file_bytes: bytes,
    mime_type: str,
    model_name: str,
) -> tuple[Form1098Details, GeminiUsage]:
    contents = [
    ...
    return await generate_content_with_retries(
        ...
        contents=contents,
        response_schema=Form1098Details,
    )
